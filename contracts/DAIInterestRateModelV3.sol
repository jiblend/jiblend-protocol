...
/**
 * @title JLEND's DAIInterestRateModel Contract (version 3)
 * @author JLEND (modified by Dharma Labs)
 * @notice The parameterized model described in section 2.4 of the original JLEND Protocol whitepaper.
...
contract DAIInterestRateModelV3 is JumpRateModelV2 {
  ...
  ) public view override(InterestRateModel, BaseJumpRateModelV2) returns (uint) {
