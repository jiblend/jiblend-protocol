...
import "./JErc20Delegate.sol";

/**
 * @title JLEND's CDai Contract
 * @notice JToken which wraps Multi-Collateral DAI
 * @author JLEND
 */
contract CDaiDelegate is JErc20Delegate {
  /**
