...
/**
 * @title JLEND's JEther Contract
 * @notice JToken which wraps Ether
 * @author JLEND
 */
contract JEther is JToken {
  /**
   * @notice Construct a new JEther money market
   ...
   */
  function liquidateBorrow(address borrower, JToken jTokenCollateral) external payable {
    liquidateBorrowInternal(borrower, msg.value, jTokenCollateral);
  }
  ...
  /**
   * @notice Send Ether to JEther to mint
   */
